...
namespace MonoGdx.Graphics.G2D
{
    public class Sprite : TextureRegion
    {
        ...
        {
            float minx = _computed[0].Position.X;
            minx = (minx > _computed[1].Position.X) ? _computed[1].Position.X : minx;
            minx = (minx > _computed[2].Position.X) ? _computed[2].Position.X : minx;
            minx = (minx > _computed[3].Position.X) ? _computed[3].Position.X : minx;

            float miny = _computed[0].Position.Y;
            miny = (miny > _computed[1].Position.Y) ? _computed[1].Position.Y : miny;
            miny = (miny > _computed[2].Position.Y) ? _computed[2].Position.Y : miny;
            miny = (miny > _computed[3].Position.Y) ? _computed[3].Position.Y : miny;

            float maxx = _computed[0].Position.X;
            maxx = (maxx < _computed[1].Position.X) ? _computed[1].Position.X : maxx;
            maxx = (maxx < _computed[2].Position.X) ? _computed[2].Position.X : maxx;
            maxx = (maxx < _computed[3].Position.X) ? _computed[3].Position.X : maxx;

            float maxy = _computed[0].Position.Y;
            maxy = (maxy < _computed[1].Position.Y) ? _computed[1].Position.Y : maxy;
            maxy = (maxy < _computed[2].Position.Y) ? _computed[2].Position.Y : maxy;
            maxy = (maxy < _computed[3].Position.Y) ? _computed[3].Position.Y : maxy;
